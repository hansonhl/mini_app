...
'''
python manage.py run -m Test  (  jobs/tasks/Test.py )
python manage.py run -m test/Index (  jobs/tasks/test/Index.py )
...
class Job( Command ):
    ...
    def run(self,*args,**kwargs):
        ...
        try:
            import_string = "from jobs.tasks.%s import Task as job_target" % (module_name)
